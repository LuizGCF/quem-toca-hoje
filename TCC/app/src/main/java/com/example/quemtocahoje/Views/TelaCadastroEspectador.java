...
public class TelaCadastroEspectador extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnCadastrarEspectador.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                if(isCamposValidos(nomeEspectador, loginEspectador, senhaEspectador, confirmarSenhaEspectador)){
                    if(isUsuarioUnico(loginEspectador)) {
                        if (isSenhaCorreta(senhaEspectador, confirmarSenhaEspectador)) {
                            ...
                            EspectadorEntity e = criarObjectoEspectador(id, a.getLogin(), a.getDataCriacao());
    ...
    private boolean isCamposValidos(EditText nomeEspectador, EditText loginEspectador, EditText senhaEspectador, EditText confirmarSenhaEspectador){
